@php
    ...
    $complete_task = $client->tasks()->where('status', "Complete")->count(); // Current amount
    // $complete_task = 1; // Current amount
...
@section('content')
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="dropdown ml-auto sm:hidden">
                         ...
                         <a href="{{route('task.create', $client)}}" class="btn btn-outline-secondary hidden sm:flex">Add Users</a>
                    </div>
                    <div class="p-5">
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <ul class="nav nav-link-tabs w-auto ml-auto hidden sm:flex" role="tablist" >
                            <li id="latest-tasks-last-week-tab" class="nav-item" role="presentation"> <a href="javascript:;" class="nav-link py-5 active" data-tw-target="#latest-tasks-last-week" aria-selected="true" role="tab" > New Task </a> </li>
                        </ul>
                    </div>
                    <div class="p-5">
                        <div class="tab-content">
    ...
    <div class="">
        <div class="text-right mt-5">
            ...
            <a href="{{route('clients.delete', $client->id)}}" onclick="return confirm('Are you sure you want to delete this item')"  type="submit" class="btn btn-primary w-24">Delete</a>
        </div>
    </div>
@endsection
