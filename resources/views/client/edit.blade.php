...
<div class="content content--top-nav">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="relative w-100 ">
                                    ...
                                    <input type="text" name="start_date" class="datepicker form-control pl-12"
                                        data-single-mode="true" value="{{$client->start_date}}">
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-span-12 lg:col-span-6">
                            <div class="mt-2">
                                ...
                                <div class="relative w-100 ">
                                    ...
                                    <input type="text" name="end_date" class="datepicker form-control pl-12"
                                        data-single-mode="true" value="{{$client->last_date}}">
                                </div>
                            </div>
                        </div> --}}
                        <div class="col-span-12 lg:col-span-6">
                            <div class="mt-2">
                                ...
                                <div class="relative w-100 ">
                                    ...
                                    <input type="text" name="reporting_date" class="datepicker form-control pl-12"
                                        data-single-mode="true" value="{{$client->reporting_date}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="relative w-100 ">
                                    ...
                                    <input type="text" name="landingpage_date" class="datepicker form-control pl-12"
                                        data-single-mode="true" value="{{$client->landingpage_date}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mt-2">
                                <div class="hiddenCB">
                                    ...
                                    <div style="display: flex; gap: 10px">
                                        ...
                                        <input type="checkbox" name="services[]" value="{{ $service->id }}" id="{{ $service->id}}" {{ $client->services->contains($service) ? 'checked' : '' }}> <label for="{{ $service->id}}">{{ $service->name }} </label>
                                        @endforeach
    ...
    <div class="intro-y flex items-center mt-8">
        ...
        <a href="{{route('task.create', $client->id)}}" class="btn btn-primary shadow-md mr-2">Add New Task</a>
    </div>
                    ...
                    <table id="example" class="table table-report">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                {{-- @if($permcmnt->edit == 1) --}}
                                                <a class="btn btn-warning mr-1 mb-2" href="{{ route('task.edit',$item->id) }}" > <i data-lucide="edit" style="color: #fff" class="w-5 h-5"></i> </a>
                                                {{-- @endif --}}
                                                {{-- @if($permcmnt->delete == 1) --}}
                                                <a href="{{route('task.delete', $item->id)}}" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-danger mr-1 mb-2"> <i data-lucide="trash" class="w-5 h-5"></i> </a>
                                                {{-- @endif  --}}
                                            </td>
                                            </tr>
                                            @endforeach
