                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mt-2">
                                        ...
                                        <input id="regular-form-3" name="year" type="text"  class="form-control" placeholder="Holiday Year" value="{{$holiday->year}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="intro-y col-span-12 lg:col-span-6">
                                    ...
                                    <input id="regular-form-3" name="total" type="text" value="{{$holiday->total}}" class="form-control" placeholder="Total Holidays" >
                                </div>
                                <div class="intro-y col-span-12 lg:col-span-6">
                                    <label for="vehicle-type" class="form-label">Remaining</label>
                                    <input id="regular-form-3" name="remaining" type="number" value="{{$holiday->remaining}}" max="{{$holiday->total}}" class="form-control" placeholder="Remaining Holidays" >
