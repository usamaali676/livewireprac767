                ...
                <div class="preview">
                    <form action="{{route('vehicle.update',$vehicle->id)}}" method="POST">
                        ...
                        <div class="mt-3">
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                <div class="intro-y col-span-12 lg:col-span-6">
                                    ...
                                    <input id="regular-form-3" name="vehicle_number" type="text" value="{{$vehicle->vehicle_number}}" class="form-control" placeholder="Vehicle Number">
                                </div>
                                <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="mt-3">
                                    ...
                                    <textarea name="description" id="" class="form-control" >{{$vehicle->description}}</textarea>
                        </div>
